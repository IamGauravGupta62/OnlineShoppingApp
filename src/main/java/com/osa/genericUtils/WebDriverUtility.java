...
public class WebDriverUtility {
	 ...
	 * @param expectMsg
	 */
	public void switchToBasedOnTitle(WebDriver driver, String expectMsg) {
		Set<String> allwh = driver.getWindowHandles();
		for (String str : allwh) {
			driver.switchTo().window(str);
			String title = driver.getTitle();
			if (title.contains(expectMsg)) {
				break;
			}
		}
	}
	...
	/**
	 * This method is used to takeScreenshot of particular element
	 * @param driver
	 * @param screenshotName
	 * @return
	 */
	public String takeScreenShotOfWebElement(WebElement element, String screenshotName)
	{
	  ...
	  File src=t.getScreenshotAs(OutputType.FILE);
	   File dest=new File("./sceeenshot/"+screenshotName+".png");
